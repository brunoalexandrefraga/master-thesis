...
E_num = [1, 0]
E_den = [1, 2 * zeta_meas * omega_n_meas, omega_n_meas**2]

E_sys = signal.TransferFunction(E_num, E_den)
```
...
num = [(N * omega_n_meas**2 / KVCO) * (2 * zeta_meas / omega_n_meas), N * omega_n_meas**2 / KVCO]
